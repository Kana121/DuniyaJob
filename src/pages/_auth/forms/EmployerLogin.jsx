...
const EmployerLogin = () => {
  return(
    ...
    <div className="md:w-1/3 max-w-sm border-2 p-5 rounded-lg bg-white shadow-md ">
      ...
      <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 text-black rounded" type="text" placeholder="Email Address" />
      <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded text-black mt-4" type="password" placeholder="Password" />
