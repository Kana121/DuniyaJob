...
//             <Typography variant="h4" className="text-white text-center md:text-left mb-8">Employee Login</Typography>
          ...
          <div className="md:w-1/2 p-8">
            ...
            <div className="text-center md:text-left">
              ...
              <button
                ...
                className="mx-1 h-9 w-9 rounded-full bg-blue-600 hover:bg-blue-700 text-white shadow-[0_4px_9px_-4px_#3b71ca]"
              >
                <svg className="mx-auto h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                  <path
                    d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"
                  />
                </svg>
            ...
            <div className="mt-4 font-semibold text-sm text-gray-700 text-center md:text-left">
              <Link to="/employee-sign-up">
                Don't have an account? <a className="text-red-600 hover:underline hover:underline-offset-4" href="/">
                  Register
                </a>
              </Link>
            </div>
