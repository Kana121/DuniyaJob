...
const SearchSuggestions = () => {
    ...
    return (
        <Box display="flex" borderRadius='md' marginTop='30px' border="double #CCCC" textAlign='left' className=" bg-inherit text-black overflow-y-scroll rounded-lg " sx={{boxShadow:15,":hover":{boxShadow:20}}}>
            <Box width='35%' borderRight='double #CCCC' id="JobsListUL" height='310px' overflowY='scroll' position='relative' className='overflow-y-scroll rounded-lg'>
                <Box display="flex" width="100%" position='sticky' top='0' left='0' paddingLeft='8px' justifyContent='flex-start' alignItems='center' zIndex='1' boxShadow='0px 2px 2px 0px #CCCC' sx={{bgcolor:"whitesmoke"}}>
                    <TextField type="text" fullWidth  placeholder='Search job here...' onChange={handleJobSearch} className='rounded-2xl border-none' />
