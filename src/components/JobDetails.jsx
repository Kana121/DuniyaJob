        ...
        {data &&
          data
            ...
            .map((x, index) => {
              return (
                <div key={index}>
                  <div className="job-details-head p-2 md:px-40 py-10 bg-gradient-to-r from-teal-400 via-purple-600 to-orange-500 h-auto w-full text-white ">
                    <span className="FIELD1">
                      Jobs {">"} Legal {">"} Across India {">"} {x.Loction} {">"}{" "}
                      {x.job_titel}{" "}
                    </span>
